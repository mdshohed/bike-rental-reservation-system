  ...
  return (
    <div>
      ...
      <h2 className="text-2xl text-white font-bold mb-4 text-center">
        We have an <span className="text-yellow-300">incredible facility</span> for every Bike Rental User
      </h2>
      <p className="text-lg text-white text-center">
        Enjoy seamless bike rentals with our top-tier service, tailored for every adventure.
      </p>
          </div>
