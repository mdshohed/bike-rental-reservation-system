    ...
    <div className="max-w-7xl px-[5%] mx-auto">
      ...
      <div  className=" flex flex-col md:flex-row justify-around items-center py-5">
          ...
          onStopSpinning={() => {
            setMustSpin(false);
            setShowCoupon(true);
            handleShowCouponCode(data[prizeNumber].option)
          }}
        /> 
    
       
        <div>
          <h1 className="text-lg font-medium">How to Apply Your Coupon Code:</h1>
          <List
            ...
            renderItem={(item) => (
              <List.Item>
                <List.Item.Meta className="text-lg font-medium"
      ...
      <div className="flex justify-center items-center">
        ...
        {/* {showCoupon && (
            <div className="mt-4 p-4 bg-green-100 border border-green-300 rounded">
              ...
              <p className="text-2xl font-bold">{data[prizeNumber].option}</p>
              <p>
                Use coupon code:{" "}
                <span className="font-bold">
                  {data[prizeNumber].couponCode}
                </span>
              </p>
              <p>Apply this code during checkout to get your discount!</p>
            </div>
          )} */}
      </div>
    </div>
