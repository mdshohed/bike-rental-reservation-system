        ...
        >
          <div className="relative mx-auto max-w-5xl text-center">
            ...
            <h2 className="text-2xl font-bold mb-4 text-center">
              We have an{" "}
              <span className="text-yellow-300">incredible facility</span> for
              every Bike Rental User
            </h2>
            <p className="text-lg text-center">
              Enjoy seamless bike rentals with our top-tier service, tailored
              for every adventure.
            </p>
          </div>

          <div className="relative  z-10 grid grid-cols-1 gap-5 pt-14 sm:grid-cols-2 lg:grid-cols-3">
            <AnimatedBackground
              className="rounded-md bg-gray-900 dark:bg-gray-100 z-10"
              transition={{
                type: "spring",
                bounce: 0.2,
                duration: 0.6,
              ...
              enableHover
            >
              <div key={1} data-id={`card-${1}`} className="rounded-md border  bg-white dark:bg-gray-900 p-8 text-center shadow">
                <div
              ...
              <div key={2} data-id={`card-${2}`} className="rounded-md p-8 border bg-white dark:bg-gray-900  text-center shadow">
                <div
                  className="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border "
                  style={{
                    backgroundImage:
              ...
              <div  key={3} data-id={`card-${3}`} className="rounded-md border bg-white dark:bg-gray-900  p-8 text-center shadow">
                <div
                  className="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border "
                  style={{
                    backgroundImage:
